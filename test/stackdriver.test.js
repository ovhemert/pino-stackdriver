...
test('transforms default log entry levels', t => {
  ...
  const logs = [
    { level: 10, time: parseInt(1532081790710), msg: 'trace message', pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 },
    { level: 20, time: parseInt(1532081790720), msg: 'debug message', pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 },
    { level: 30, time: parseInt(1532081790730), msg: 'info message', pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 },
    { level: 40, time: parseInt(1532081790740), msg: 'warning message', pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 },
    { level: 50, time: parseInt(1532081790750), msg: 'error message', pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', type: 'Error', stack: 'Error: error message', v: 1 },
    { level: 60, time: parseInt(1532081790760), msg: 'fatal message', pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 }
  ]
...
test('transforms custom log entry level', t => {
  ...
  const log = { level: 35, time: parseInt(1532081790735), msg: 'custom level message', pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 }
...
test('prefixes log entry message', t => {
  ...
  const log = { level: 30, time: parseInt(1532081790730), msg: 'info message', pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 }
...
test('adds labels to log entry message', t => {
  ...
  let log = { level: 30, time: parseInt(1532081790730), labels: { foo: 'bar' }, pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 }
  ...
  log = { level: 30, time: parseInt(1532081790730), msg: 'info message', pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 }
  entry = tested.toLogEntry(log, { labels: { a: 'b' } })
  t.ok(entry.meta.severity === 'info')

  log = { level: 30, time: parseInt(1532081790730), labels: { foo: 'bar' }, pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 }
...
test('adds httpRequest to log entry message', t => {
  ...
  const log = { level: 30, time: parseInt(1532081790730), httpRequest: { url: 'http://localhost/' }, pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 }
  const entry = tested.toLogEntry(log)
  t.ok(entry.meta.severity === 'info')
...
test('transforms log to entry in stream', t => {
  ...
  const entry = { level: 30, time: parseInt(1532081790743), msg: 'info message', pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 }
