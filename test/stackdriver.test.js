...
test('transforms default log entry levels', t => {
  ...
  const logs = [
    { level: 10, time: 1532081790710n, msg: 'trace message', pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 },
    { level: 20, time: 1532081790720n, msg: 'debug message', pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 },
    { level: 30, time: 1532081790730n, msg: 'info message', pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 },
    { level: 40, time: 1532081790740n, msg: 'warning message', pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 },
    { level: 50, time: 1532081790750n, msg: 'error message', pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', type: 'Error', stack: 'Error: error message', v: 1 },
    { level: 60, time: 1532081790760n, msg: 'fatal message', pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 }
  ]
...
test('transforms custom log entry level', t => {
  ...
  const log = { level: 35, time: 1532081790735n, msg: 'custom level message', pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 }
...
test('prefixes log entry message', t => {
  ...
  const log = { level: 30, time: 1532081790730n, msg: 'info message', pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 }
...
test('adds labels to log entry message', t => {
  ...
  let log = { level: 30, time: 1532081790730n, labels: { foo: 'bar' }, pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 }
  ...
  log = { level: 30, time: 1532081790730n, msg: 'info message', pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 }
  entry = tested.toLogEntry(log, { labels: { a: 'b' } })
  t.ok(entry.meta.severity === 'info')

  log = { level: 30, time: 1532081790730n, labels: { foo: 'bar' }, pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 }
...
test('adds httpRequest to log entry message', t => {
  ...
  const log = { level: 30, time: 1532081790730n, httpRequest: { url: 'http://localhost/' }, pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 }
  const entry = tested.toLogEntry(log)
  t.ok(entry.meta.severity === 'info')
...
test('transforms log to entry in stream', t => {
  ...
  const entry = { level: 30, time: 1532081790743n, msg: 'info message', pid: 9118, hostname: 'Osmonds-MacBook-Pro.local', v: 1 }
